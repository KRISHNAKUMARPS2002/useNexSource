  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="absolute inset-0 bg-white/5 backdrop-blur-[3px] flex flex-col justify-center items-center text-center px-4">
        {/* Small Tag */}
        <span className="px-2 py-1 border border-gray-200/20 text-white  text-[15px] bg-gray-200/10 rounded-full">
          useNexSource
        </span>
        ...
        <div className="flex gap-2 sm:gap-4 items-center justify-center pt-8">
          <button className="py-2 px-3 sm:py-3 sm:px-6 rounded-2xl text-white bg-black cursor-pointer">
            Book a demo
          </button>
          <button className="py-2 px-3 sm:py-3 sm:px-6 rounded-2xl text-white border-2 border-white bg-white/0 backdrop-blur-md hover:bg-white/5 transition duration-200 cursor-pointer">
            Learn more
          </button>
        </div>
      </div>
